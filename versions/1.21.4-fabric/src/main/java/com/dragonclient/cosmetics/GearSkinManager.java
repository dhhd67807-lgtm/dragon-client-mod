...
public final class GearSkinManager {
    ...
    static {
        OPTIONS.put(Category.SWORD, new SkinOption[] {
            ...
            new SkinOption("Void Colossus Broadsword", "dc_void_colossus_broadsword")
        });
        ...
        OPTIONS.put(Category.PICKAXE, new SkinOption[] {
            ...
            new SkinOption("Void Colossus Pickaxe", "dc_void_colossus_pickaxe")
        });
        ...
        OPTIONS.put(Category.AXE, new SkinOption[] {
            ...
            new SkinOption("Void Colossus Axe", "dc_void_colossus_axe")
        });
