...
public class SkinManager {
    ...
    private Identifier loadSkinTexture(String key, Path skinFile) {
        try {
            ...
            NativeImageBackedTexture texture = new NativeImageBackedTexture(() -> "dragonclient_skin_" + key, image);
    ...
    private Identifier loadCapeTexture(String key, Path capeFile) {
        try {
            ...
            NativeImageBackedTexture texture = new NativeImageBackedTexture(() -> "dragonclient_cape_" + key, image);
