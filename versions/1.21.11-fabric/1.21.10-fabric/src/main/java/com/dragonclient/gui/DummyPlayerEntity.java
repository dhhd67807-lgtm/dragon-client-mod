...
public class DummyPlayerEntity extends OtherClientPlayerEntity {
    ...
    public DummyPlayerEntity(ClientWorld world, GameProfile profile) {
        super(world, profile);
        // 1.21.10: PLAYER_MODEL_PARTS removed - skip model parts setup
    ...
    // 1.21.10: getSkinTextures removed - cape functionality disabled
    
    // 1.21.10: isPartVisible signature may have changed
