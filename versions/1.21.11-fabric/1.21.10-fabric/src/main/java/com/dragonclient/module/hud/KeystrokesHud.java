...
public class KeystrokesHud extends HudModule {
    ...
    private void drawKey(DrawContext context, String key, int x, int y, boolean pressed, int width) {
        ...
        // 1.21.10: drawBorder removed - draw manually
        context.fill(x, y, x + width, y + 1, 0xFFFFFFFF); // Top
        context.fill(x, y + 17, x + width, y + 18, 0xFFFFFFFF); // Bottom
        context.fill(x, y, x + 1, y + 18, 0xFFFFFFFF); // Left
        context.fill(x + width - 1, y, x + width, y + 18, 0xFFFFFFFF); // Right
