...
public class DragonMenuScreen extends Screen {
    ...
    // -------------------------------------------------------------------------
    // Input - 1.21.10: Custom click handler (called via MixinMouse)
    // -------------------------------------------------------------------------
    
    // This method handles the actual click logic
    ...
    public boolean keyPressed(int keyCode, int scanCode, int modifiers) {
        ...
        // Don't call super - keyPressed signature changed in 1.21.10
        return false;
    }
