...
public class HudEditorScreen extends Screen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        // Draw dragon logo (1.21.1-1.21.10: old signature without RenderPipelines)
        int logoX = centerX - logoSize / 2;
        context.drawTexture(DRAGON_LOGO, logoX, startY, 0, 0, logoSize, logoSize, logoSize, logoSize);
